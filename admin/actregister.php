					...
					if ($currentUser > 0){
						...
						$message = "<html>
							<body>
								...
								<a href=\"$website_url/admin/activation.php?activeuser=$username&key=$passmd5\" title=\"Account Activation\">$website_url/admin/activation.php?activeuser=$username&key=$passmd5</a><br /><br />
