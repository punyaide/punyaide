...
$aksi="component/cogen/proses.php";
?>
<?php if ($_SESSION[leveluser]=='1'){ ?>
	<div class="content-header">
		<div class="header-section"><h1>WisasiCMS Generator</h1></div>
	</div>
	<ul class="breadcrumb breadcrumb-top">
		<li><a href="admin.php?mod=home"><?=$langmenu1;?></a></li>
		<li>WisasiCMS Generator</li>
	</ul>
<?php
switch($_GET[act]){
	default:
			...
			<div class="col-md-4">
				<div class="widget">
					<div class="widget-advanced">
						<div class="widget-header text-center" style="background:url('component/cogen/compogen-bg.jpg'); background-size:cover;">
						...
						<div class="widget-main" style="border-left:1px solid #ecf0f1;border-right:1px solid #ecf0f1;border-bottom:1px solid #ecf0f1;">
							...
							<h3 class="text-center animation-fadeIn"><small>Buat component WisasiCMS dengan generator ini tanpa perlu menuliskan code apapun. Buat component semudah menjentikkan jari.</small></h3>
						</div>
					</div>
				</div>
			</div>
