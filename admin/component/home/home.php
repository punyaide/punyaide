...
if (empty($_SESSION['namauser']) AND empty($_SESSION['passuser'])) {
	...
	if ($_SESSION[leveluser] == '1' OR $_SESSION[leveluser] == '2') {
		$table1  = new WisasiTable('post');
		$total1  = $table1->numRow();
		$table2  = new WisasiTable('category');
		$total2  = $table2->numRow();
		$table3  = new WisasiTable('tag');
		$total3  = $table3->numRow();
		$table4  = new WisasiTable('media');
		$total4  = $table4->numRow();
		$table5  = new WisasiTable('pages');
		$total5  = $table5->numRow();
		$table6  = new WisasiTable('component');
		$total6  = $table6->numRow();
		$table7  = new WisasiTable('users');
		$total7  = $table7->numRow();
		$table8  = new WisasiTable('comment');
		$total8  = $table8->numRowBy(status, 'N');
		$table9  = new WisasiTable('contact');
		...
		include "component/home/traffic.php";
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="block">
				...
				<form id="form-validation" action="component/home/proses.php" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
					<div class="form-group">
						<label class="col-md-4 control-label" for="example-chosen">One Click Backup DB :</label>
						<div class="col-md-6">
							<a href="component/home/proses.php?mod=home&act=backup" class="btn btn-sm btn-primary"><i class="fa fa-download"></i> Backup DB</a>
						</div>
					</div>
					<div class="form-group">
