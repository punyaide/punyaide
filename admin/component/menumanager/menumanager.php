...
include 'component/menumanager/includes/configure.php';
include 'component/menumanager/includes/functions.php';
switch($_GET[act]){
  default:
	$tablemenu = new WisasiTable('menu_group');
	...
	if ($menus != "0"){
		...
		class WisasiController {
			...
			public function __construct() {
				include 'component/menumanager/includes/db.php';
				$this->db = new DB;
			...
			protected function view($view_file, $data = '') {
				...
				$file = 'component/menumanager/templates/' . $view_file . '.php';
				if (file_exists($file)) {
					include $file;
				} else {
		...
		$controller_file = 'component/menumanager/modules/' . $controller . '.php';
		if (file_exists($controller_file)) {
			...
			$controller_file = 'component/menumanager/modules/menu.php';
			include $controller_file;
			$instance = new Menu;
		...
		$table = new WisasiTable('menu_group');
		$table->save(array(
			'id' => '1',
			'title' => 'Main Menu'
		));
