...
?>
	...
	<div class="block full">
		...
		<div class="row">
			...
			<div class="col-md-8 ul-menu">
				<form method="post" id="form-menu" action="component/menumanager/proses.php?mod=menu&act=save_position">
			...
			<div class="col-md-4">
				...
				<div class="box">
					<h2>Add Menu</h2>
					<section>
						<form class="form-bordered" id="form-add-menu" method="post" action="component/menumanager/proses.php?mod=menu&act=add">
