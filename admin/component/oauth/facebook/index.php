...
<?php if ($user): ?>
	...
	<html lang="en">
		<head>
			...
			<meta name="description" content="WisasiCMSOAuth 1.0 - Connect facebook to your website for automatic publish content to facebook from your post">
			<meta name="author" content="WisasiCMS">
			<link rel="shortcut icon" href="favicon.png">

			<title>WisasiCMSOAuth 1.0 - Facebook</title>
