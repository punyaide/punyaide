...
define('OAUTH_CALLBACK', ''.$currentSettingweb.'/component/oauth/twitter/index.php');
...
?>
	...
	<html lang="en">
		<head>
			...
			<meta name="description" content="WisasiCMSOAuth 1.0 - Connect twitter to your website for automatic publish content to twitter from your post">
			<meta name="author" content="WisasiCMS">
			<link rel="shortcut icon" href="favicon.png">

			<title>WisasiCMSOAuth 1.0 - Twitter</title>
		...
		<body>
			...
			<div id="footer">
				<div class="container">
					<p class="text-muted">WisasiCMSOAuth 1.0 &copy; 2014. WisasiCMS Team. All Rights Reserved.</p>
				</div>
			</div>
