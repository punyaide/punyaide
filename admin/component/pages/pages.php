...
$aksi="component/pages/proses.php";
?>
				...
				<div class="form-group" id="image-box">
					<div class="row">
						...
						<?php }else{ ?>
							...
							<div class="col-md-9">
								<a data-toggle="lightbox-image" href="../content/upload/<?=$currentPages->picture;?>">Existing Image Preview</a>
								<p>
