...
$aksi="component/post/proses.php";
?>
...
<?php
    ...
    $permastrlink = preg_replace("/\/admin\/(admin\.php$)/","",$permastr);
?>
	<div class="block full">
		...
		<form id="form-validation" class="form-bordered" method="post" action="<?=$aksi;?>" autocomplete="off">
            <fieldset>
				...
				<?php
					$tablecats = new WisasiTable("category");
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="w-wysiwyg" name="content" style="height:500px;" required></textarea>
				</div>
				<?php
	...
	<div class="block full">
		...
		<form id="form-validation" class="form-bordered" method="post" action="<?=$aksi;?>" autocomplete="off">
            <fieldset>
				...
				<?php
					$tableselcats = new WisasiTable('category');
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="w-wysiwyg" name="content" style="height:500px;" required><?=$dutf;?></textarea>
				</div>
				<?php
					$tabletag = new WisasiTable("tag");
					$tags = $tabletag->findAll(id_tag, DESC);
				...
				<div class="form-group" id="image-box">
					<div class="row">
						...
						<?php }else{ ?>
							...
							<div class="col-md-9">
								<a data-toggle="lightbox-image" href="../content/upload/<?=$currentPosts->picture;?>">Existing Image Preview</a>
								<p>
