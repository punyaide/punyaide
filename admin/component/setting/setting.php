...
$aksi="component/setting/proses.php";
...
?>
	...
	<div class="block full">
		<div class="block-title">
			<h2>WisasiCMSOAuth - Facebook Connect</h2>
		...
		<?php
			$tableoauthfb = new WisasiTable('oauth');
				...
				<tr>
					<td colspan="2">
						<form method="post" action="<?=$aksi;?>" autocomplete="off">
							...
							<a class="btn btn-sm btn-primary" href="component/oauth/facebook/index.php"><i class="fa fa-facebook"></i> New Or Renew OAuth</a>
	...
	<div class="block full">
		<div class="block-title">
			<h2>WisasiCMSOAuth - Twitter Connect</h2>
				...
				<tr>
					<td colspan="2">
						<form method="post" action="<?=$aksi;?>" autocomplete="off">
							...
							<a class="btn btn-sm btn-primary" href="component/oauth/twitter/index.php"><i class="fa fa-twitter"></i> New Or Renew OAuth</a>
							<button class="btn btn-sm btn-danger" type="submit"><i class="fa fa-times"></i> Delete OAuth</button>
						</form>
					</td>
				</tr>
    ...
    <?php
    $filename_meta = "component/setting/meta-social.txt";
    ...
    <div class="block full">
        ...
        <form method="post" action="<?=$aksi;?>" autocomplete="off">
            ...
            <textarea class="form-control" id="wcodemirror" name="meta_content" style="width:100%; height:300px;"><?=$data_meta;?></textarea>
