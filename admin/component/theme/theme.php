...
$aksi="component/theme/proses.php";
?>
...
?>
	<div class="block full">
		...
		<div class="row">
		<?php
			$tabletheme = new WisasiTable('theme');
				...
				foreach($themes as $theme){
					...
					echo "<div class='col-sm-4 block-section text-center' id='del$theme->id_theme'>
						...
						<div class='gallery-image'>
							<img src='../content/$theme->folder/preview.jpg' alt='' style='width:100%;'>
...
<?php
	...
	$filename = "../content/$currentTheme->folder/$valid";
	if (file_exists("$filename")){
	$fh = fopen($filename, "r") or die("Could not open file!");
	$data = fread($fh, filesize($filename)) or die("Could not read file!");
	$data = str_replace("textarea", "textareawisasicms", $data);
	fclose($fh);
?>
	<style type="text/css">
	...
	<div class="block full">
		<div class="block-title">
			...
			<div class="block-options pull-right">
				<div class="btn-group btn-group-sm">
					...
					$strlink = preg_replace("/\/admin\/(admin\.php$)/","",$str);
					$folderpath = "$strlink/content/$currentTheme->folder/";
		...
		<form method="post" action="<?=$aksi;?>" enctype="multipart/form-data" autocomplete="off">
			...
			<textarea name="code_content" id="wcodemirror" style="width:100%; height:800px;"><?=$data;?></textarea>
			<p>&nbsp;</p>
			<fieldset>
				<div class="form-group form-actions">
					<button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-check"></i> Submit</button>
