...
$aksi="component/user/proses.php";
?>
...
?>
	<div class="block full">
		...
		<?php
				...
				$tablelevel = new WisasiTable('user_level');
								...
								<div class="widget-main" style="border-left:1px solid #EAEDF1;border-right:1px solid #EAEDF1;border-bottom:1px solid #EAEDF1;">
									...
									<?php
										...
										if (file_exists("$filename")){
											echo "<img src='../content/upload/user-$_SESSION[iduser].jpg' class='widget-image img-circle' alt='avatar' width='30' height='30' />";
										}else{
											echo "<img src='../content/upload/user-editor.jpg' class='widget-image img-circle' alt='avatar' width='30' height='30' />";
										}
									?>
									</a>
									<div class="row text-center animation-fadeIn">
										<div class="col-xs-6">
											<h3>
												<?php
													$tableposts = new WisasiTable("post");
...
?>
	...
	<div class="block full">
		...
		<div class="table-responsive">
		<?php
			$tableuserlevel = new WisasiTable('user_level');
...
?>
	...
	<div class="block full">
		...
		<div class="table-responsive">
		<?php
			$tableuserrole = new WisasiTable('user_role');
									...
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<select class="select-chosen-no-search" name="level" style="width:280px;" data-placeholder="Choose Level">
												<?php
													$tableselevel = new WisasiTable('user_level');
													...
													$tablelevels = new WisasiTable('user_level');
