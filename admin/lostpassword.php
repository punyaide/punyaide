		...
		if ($currentUser > 0){
			...
			$message = "<html>
				<body>
					...
					<a href=\"$website_url/admin/recover.php?forgetuser=$username&forgetkey=$forgotkey\" title=\"Recover Password\">$website_url/admin/recover.php?forgetuser=$username&forgetkey=$forgotkey</a><br /><br />
