...
<link rel="stylesheet" type="text/css" href="<?=$website_url;?>/content/<?=$folder;?>/css/component-contact.css" />
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 kontak-kotak1">
						<figure>
								<div class="drawings iphone big-logo">
									<img class="illustration" src="<?=$website_url;?>/content/<?=$folder;?>/images/iphone.png" alt="iPhone Illustration" />
									<svg class="line-drawing" id="iphone andred" width="100%" height="600" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 600">
					...
					<div class="col-md-4 kontak-kotak">
						<h2>Contact Us</h2>
						<p>Text/Whatsapp: +62 8569939100</p>
						<p>BBM: 589EB36A</p>
						<p>Email: info@punyaide.com</p>
						<p>Instagram: punyaide</p>
						<p>Twitter: punyaIdeDotCom</p>
						<p>Facebook: punyaidedotcom</p>
						<p>Kontak kami untuk melakukan pemesanan. Keterangan lebih lanjut lihat <a href="faq">FAQ</a></p>
					</div>
				</div>
			</div>
		</div>
...
<?php include_once "content/$folder/footer.php"; ?>
		<script src="<?=$website_url;?>/content/<?=$folder;?>/js/classie.js"></script>
		<script src="<?=$website_url;?>/content/<?=$folder;?>/js/svganimations.js"></script>
<?php } ?>