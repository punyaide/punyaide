...
class WisasiController {
    ...
    public function __construct() {
        include 'admin/component/menumanager/includes/db.php';
        $this->db = new DB;
        $this->db->Connect(DATABASE_HOST, DATABASE_USER, DATABASE_PASS, DATABASE_NAME);
        include 'admin/component/menumanager/includes/tree.php';
    }
    /**
     ...
     * @return string
     */
    function wisasi_menu($group_id, $attr = '', $attrs = '', $attrss = '') {
        $tree    = new Tree;
