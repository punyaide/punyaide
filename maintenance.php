...
<head>
    ...
    <meta name="description" content="WisasiCMS Under Maintenance" />
    <meta name="keywords" content="Wisasicms" />
	...
	<link type="text/css" rel="stylesheet" href="admin/css/maintenance.css" />
</head>
<body>
	<section id="intro">
		<div class="container">
	...
	<script type="text/javascript" src="admin/js/vendor/jquery-1.11.0.min.js"></script>
	<script type="text/javascript" src="admin/js/vendor/jquery.counteverest.min.js"></script>
